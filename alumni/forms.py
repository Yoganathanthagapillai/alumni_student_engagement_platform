...
class AlumniCreationForm(forms.ModelForm):
    ...
    class Meta:
        model = Alumni
        fields = ['name', 'usn', 'phone', 'svc_email', 'email', 'branch', 'year_joined', 'year_passed', 'user']
        widgets = {
            ...
            'svc_email': forms.EmailInput(attrs={"class": "form-control", "placeholder": "Enter the SVC email"}),
